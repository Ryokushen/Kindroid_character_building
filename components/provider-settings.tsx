...
const PROVIDER_PRESETS: Array<{
  ...
  },
  {
    ...
    models: [
      { id: "grok-4", label: "Grok 4", description: "Most powerful — deep reasoning (2M ctx)" },
      { id: "grok-3", label: "Grok 3", description: "Strong all-rounder" },
      { id: "grok-3-mini", label: "Grok 3 Mini", description: "Fast — efficient reasoning" },
    ],
  },
];
